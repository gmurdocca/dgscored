...
class ContestantViewSet(viewsets.ModelViewSet):
    ...
    League objects map to several Contestant objects. If initial HC is not specified, then it will be
...
class HoleViewSet(viewsets.ModelViewSet):
    """
    A simple model to reporesent a hole. Only Hole number and Par are required.
    """
...
class LayoutViewSet(viewsets.ModelViewSet):
    ...
    Courses relate to one or more of these.
    """
...
class ScoreViewSet(viewsets.ModelViewSet):
    ...
    one Score per player on the Card.
    """
...
class AwardViewSet(viewsets.ModelViewSet):
    """
    A generic Award model to capture awards such as Aces (hole in one) or CTP's (closest to pin).
    Event objects relate to one or more Awards.
    """
...
class EventViewSet(viewsets.ModelViewSet):
    ...
    Contestant is required to play during the event, as well as Awards and Cards created during that
    event.
    """
...
class LeagueViewSet(viewsets.ModelViewSet):
    """
    A model to represent a League. Stores all the events and contestants associated with it.
    """
